...
output "aft_vpc_id" {
  value = module.aft-vpc.vpc_id
}

output "aft_vpc_public_subnets" {
  value = module.aft-vpc-subnets.public_subnet_ids
}

output "aft_vpc_private_subnets" {
  value = module.aft-vpc-subnets.private_subnet_ids
}

output "aft_vpc_default_sg" {
  value = [module.aft-default-sg.id]
}
